"""
Django settings for Casualty_backend project.
...
SECRET_KEY = 'django-insecure-kwv&t8bm-8u7_z510j(_f%^9g+%bxcczh=p9&v9g_w62zkeuv='
...
ROOT_URLCONF = 'Casualty_backend.urls'
